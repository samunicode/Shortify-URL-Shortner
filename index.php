...
function generate_random_string($length = 7) {
	global $conn;
    $characters = "abcdefghijklmnopqrstuvwxyzABCDEFG!$@HIJKLMNOPQRSTUVW()_-XYZ0123=456789";
    ...
    <div class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
      <div class="flex flex-row items-center justify-between py-2">
        <div class="relative md:mt-8 mt-4">
          <a href="https://shortify.live/"><img class="relative md:w-1/4 w-2/5" src="img/nav_logo.png"
              alt="MUJ Central"></a>
        </div>
      ...
      <nav :class="{ 'transform md:transform-none': !open, 'h-full': open }"
        ...
        <a class="font-bold text-white whitespace-nowrap px-4 py-2 mt-2 text-lg bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline"
          href="https://shortify.live/comingsoon.html"><span class='hover-underline-animation text-white'>Pricing</span></a>

        <a class="font-bold text-white whitespace-nowrap px-4 py-2 mt-2 text-lg bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline"
          href="https://shortify.live/comingsoon.html"><span
            class='hover-underline-animation text-white'>Features</span></a>
        <a class="font-bold text-white whitespace-nowrap px-4 py-2 mt-2 text-lg bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline"
          href="https://shortify.live/comingsoon.html"><span class='hover-underline-animation text-white'><span
              class='hover-underline-animation text-darken'>Other Tools</span></span></a>
        <a class="font-bold text-white whitespace-nowrap px-4 py-2 mt-2 text-lg bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline"
          href="https://shortify.live/comingsoon.html"><span class='hover-underline-animation text-white'>Check URL</span></a>
          
        <a href="https://shortify.live/comingsoon.html">
          <a class="font-bold whitespace-nowrap px-10 py-3 mt-2 text-lg text-center bg-white text-black rounded-full md:mt-8 md:ml-4"
            href="https://shortify.live/comingsoon.html">
            Support</a></a>
      </nav>
    </div>
  </div>
    ...
    <div class="flex justify-center items-center bg-cover bg-center"
      ...
      <div class="space-y-5 p-5 pt-24 pb-24 md:pr-14 md:pl-14 mr-4 ml-4" style="/* From https://css.glass */
        ...
        <div class="flex flex-row items-center justify-center">
          ...
          {
             echo "https://shortify.live/".$shortened_url; 
          }
          else 
          {  
	   ...
	   <footer class="bg-black rounded-lg shadow m-4 pt-10">
      <div class="w-full mx-auto max-w-screen-xl p-4 flex justify-center items-center ">
        <span class="hover-underline-animation text-xl text-center font-semibold text-white text-sm text-white-500 sm:text-center">Project Created by Sameer & Gourav
      </span>
      </div>
  </footer>
